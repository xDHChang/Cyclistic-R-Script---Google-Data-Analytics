...
setwd("C:/Users/Adminboi/Documents") 
#sets your working directory to simplify calls to data changed from "/cloud/project"
#=====================
# STEP 1: COLLECT DATA
#=====================
# Upload Divvy datasets (csv files) here
q2_2019 <- read_csv("Divvy_Trips_Original_2019_Q2.csv")
q3_2019 <- read_csv("Divvy_Trips_Original_2019_Q3.csv")
q4_2019 <- read_csv("Divvy_Trips_Original_2019_Q4.csv")
q1_2020 <- read_csv("Divvy_Trips_Original_2020_Q1.csv")
...
all_trips_v2 %>% 
  ...
  scale_y_continuous(labels = scales::comma) #HOLY BUTTS IT WORKED
...
write.csv(counts, file = 'C:/Users/Adminboi/Documents/avg_ride_length.csv')

#C:\Users\Adminboi\Desktop\Capstone
